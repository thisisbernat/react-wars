    ...
    <Layout>
      <div className="flex-1 flex flex-col mx-12 md:mx-38 md:max-w-1/3 mt-10 md:mt-0 md:justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="bg-zinc-800 p-4 rounded flex flex-col gap-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-white font-medium p-3">Page {currentPage === '' ? '1' : currentPage}</div>
          ...
          {location === '/' && <div className="bg-zinc-800 rounded flex justify-center items-center">
            <Details isPersonSelected={false} />
          </div>}
          <Route path="/character/:personId">
            {(params) => (
              <div className="bg-zinc-800 rounded flex justify-center items-center mb-5">
