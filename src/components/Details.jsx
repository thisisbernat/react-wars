...
export default function Details({ personId, isPersonSelected = true }) {
  ...
  if (!isPersonSelected) {
    ...
    if (isLoading) {
      ...
      return (
        <div className="text-zinc-800 dark:text-slate-200 flex flex-col items-center text-center mx-5 my-4">
          <h1 className="text-3xl font-bold mb-2 dark:text-white">{person.name}</h1>
